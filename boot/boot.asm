...
;===============================================================================================
	...
	org  07c00h				; Bios 将把 Boot Sector 加载到 0:7C00 处并开始执行

BaseOfStack	equ	07c00h		; Boot状态下堆栈基地址(栈底, 从这个位置向低地址生长)

	jmp short LABEL_START	; 这条语句必须是在BIN文件第一字节处
	nop						; 这个 nop 不可少

%include	"load.inc"		;LOADER.BIN,KERNEL.BIN,页目录表和页表在物理空间的位置
%include	"fat12hdr.inc"	;fat12格式的文件结构描述
